# @wemnyelezxnpm/sapiente-quasi-ducimus

> forked from [@wemnyelezxnpm/sapiente-quasi-ducimusode](https://www.npmjs.com/package/@wemnyelezxnpm/sapiente-quasi-ducimusode) v11.1.0. as the original repository seems [no longer maintained](https://github.com/mysticatea/@wemnyelezxnpm/sapiente-quasi-ducimusode/issues/300).

[![npm version](https://img.shields.io/npm/v/@wemnyelezxnpm/sapiente-quasi-ducimus.svg)](https://www.npmjs.com/package/@wemnyelezxnpm/sapiente-quasi-ducimus)
[![Downloads](https://img.shields.io/npm/dm/@wemnyelezxnpm/sapiente-quasi-ducimus.svg)](https://www.npmjs.com/package/@wemnyelezxnpm/sapiente-quasi-ducimus)
[![Build Status](https://github.com/wemnyelezxnpm/sapiente-quasi-ducimus/workflows/CI/badge.svg)](https://github.com/wemnyelezxnpm/sapiente-quasi-ducimus/actions)
...
```sh
npm install --save-dev eslint @wemnyelezxnpm/sapiente-quasi-ducimus
```
...
```js
const nodePlugin = require("@wemnyelezxnpm/sapiente-quasi-ducimus")
...
💼 [Configurations](https://github.com/wemnyelezxnpm/sapiente-quasi-ducimus#-configs) enabled in.\
☑️ Set in the `flat/recommended` [configuration](https://github.com/wemnyelezxnpm/sapiente-quasi-ducimus#-configs).\
🟢 Set in the `flat/recommended-module` [configuration](https://github.com/wemnyelezxnpm/sapiente-quasi-ducimus#-configs).\
✅ Set in the `flat/recommended-script` [configuration](https://github.com/wemnyelezxnpm/sapiente-quasi-ducimus#-configs).\
☑️ Set in the `recommended` [configuration](https://github.com/wemnyelezxnpm/sapiente-quasi-ducimus#-configs).\
🟢 Set in the `recommended-module` [configuration](https://github.com/wemnyelezxnpm/sapiente-quasi-ducimus#-configs).\
✅ Set in the `recommended-script` [configuration](https://github.com/wemnyelezxnpm/sapiente-quasi-ducimus#-configs).\
...
`@wemnyelezxnpm/sapiente-quasi-ducimus` follows [semantic versioning](http://semver.org/) and [ESLint's Semantic Versioning Policy](https://github.com/eslint/eslint#semantic-versioning-policy).
...
- [GitHub Releases](https://github.com/wemnyelezxnpm/sapiente-quasi-ducimus/releases)
